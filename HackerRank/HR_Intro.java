...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        Format us = NumberFormat.getCurrencyInstance(Locale.US);
        Format india = NumberFormat.getCurrencyInstance(new Locale("en", "IN"));
        Format china = NumberFormat.getCurrencyInstance(Locale.CHINA);
        Format france = NumberFormat.getCurrencyInstance(Locale.FRANCE);
